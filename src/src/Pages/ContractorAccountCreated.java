 ...
 * @version May 4, 2025
 */
public class ContractorAccountCreated extends Page implements PageInterface {
     ...
     */
    public ContractorAccountCreated(Client client) {
        super(client);
        initializeContent();
    }
    ...
    public void initializeContent() {
        ...
        goToLogin = new Button("Go to Login",
                e -> window.switchPage(new ContractorLoginPage(client)), Constants.SIZE_500_45);
        addComponents();
    }
