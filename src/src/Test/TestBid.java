...
public class TestBid {
    ...
    public void setUp() {
        ...
        contract = new Contract(null, "Test contract","Test Desc", true, null, new ArrayList<>());
    ...
    public void gettersAndSettersTest() {
        ...
        Contract newContract = new Contract(null, "New contract", "New Desc", true, null, new ArrayList<>());
